...
module.exports = {
    ...
    usage: 'settings {blacklisting, list, reset}\na+settings {enable, disable} [command]\na+settings enable all',
    description: 'Enables and disables core settings of the bot, such as blacklisting or specific commands.',
    staffOnly: true,
    ...
    */
    run: async(bot, message, args) => {
        /**  @type {{ blacklisting: boolean, blacklistLogs: boolean, disabledCommands: string[] }} */
        ...
        switch(args[0]) {
            ...
            /** @param {boolean} elem */
                ...
                const embed = new MessageEmbed()
                    .setColor(colors.ForestGreen)
                    .setDescription(
                        stripIndents`Blacklisting: \`${formatBool(data.blacklisting)}\`
