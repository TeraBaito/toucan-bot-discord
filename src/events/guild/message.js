...
const { prefix, alexServerID } = require('../../../config.json');
...
module.exports = async (bot, message) => {
    ...
    let allowedServers = [alexServerID, '386244779752816640', '711301984887636080', '601434467072212993'];
    ...
    // Blacklisting
    if (blacklisting && 
        [alexServerID, '711301984887636080'].includes(message.guild.id) &&
